...
*─────────────*
 ...
 ➻ *chats:* `{}`
*─────────────*
✪ `ʜɪᴛ` *ʜᴇʟᴘ* `ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ ʙᴜᴅᴅʏ` \n[➥](https://telegra.ph/file/dfa38d781be1a0438652b.jpg)*:*[ғɪʀꜱᴛ ᴀᴅᴅ ᴍᴇ ɪɴ ɢʀᴏᴜᴘ ᴛʜᴇɴ ꜱᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ ʙᴀʙʏ](https://t.me/Abishnoi_ro_bot?startgroup=new)
"""
...
def Galaxia_about_callback(update, context):
    ...
    elif query.data == "Galaxia_mplay":
        query.message.edit_text(
            play_cmd,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("•ɢᴏ ʙᴀᴄᴋ•", callback_data="Galaxia_music")]]
            ),
        )
    elif query.data == "Galaxia_madmin":
        query.message.edit_text(
            admin_cmd,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("•ɢᴏ ʙᴀᴄᴋ•", callback_data="Galaxia_music")]]
    ...
    elif query.data == "Galaxia_mextra":
        query.message.edit_text(
            extra_chutiyapa,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("•ɢᴏ ʙᴀᴄᴋ•", callback_data="Galaxia_music")]]
    ...
    elif query.data == "Galaxia_music":
        query.message.edit_text(
            "❣ ʜᴀʏ {},\nʜᴇᴀʀ ʜᴇʟᴘ ᴍᴇɴᴜ ғᴏʀ ᴍᴜꜱɪᴄ ".format(nm),
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🍾 ᴀᴅᴍɪɴ 🍾", callback_data="Galaxia_madmin"
                        ),
                        InlineKeyboardButton(
                            text="🍷 ᴘʟᴀʏ 🍷", callback_data="Galaxia_mplay"
                        ),
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton(
                            text="♦️ ᴍᴏʀᴇ ♦️", callback_data="help_back"
                        ),
                        InlineKeyboardButton(
                            text="🔹 ️ʙᴀᴄᴋ 🔹️", callback_data="Galaxia_back"
                        ),
                    ],
                ]
            ),
...
━━━━━━━━━━━━━
⍟ **ᴍʏ ᴏᴡɴᴇʀ :** [𝐀ʙɪꜱʜɴᴏɪ](https://t.me/ll_EDWARD_ELRIC_ll)
