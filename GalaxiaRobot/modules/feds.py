...
import GalaxiaRobot.modules.sql.feds_sql as sql
...
FBAN_ERRORS = {
    ...
    "ɴᴇᴇᴅ ᴛᴏ ʙᴇ ɪɴᴠɪᴛᴇʀ ᴏғ ᴀ ᴜꜱᴇʀ ᴛᴏ ᴋɪᴄᴋ ɪᴛ ғʀᴏᴍ ᴀ ʙᴀꜱɪᴄ ɢʀᴏᴜᴘ",
    "ᴄʜᴀᴛ_ᴀᴅᴍɪɴ_ʀᴇϙᴜɪʀᴇᴅ",
    "ᴏɴʟʏ ᴛʜᴇ ᴄʀᴇᴀᴛᴏʀ ᴏғ ᴀ ʙᴀꜱɪᴄ ɢʀᴏᴜᴘ ᴄᴀɴ ᴋɪᴄᴋ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪꜱᴛʀᴀᴛᴏʀꜱ",
    "ᴄʜᴀɴɴᴇʟ_ᴘʀɪᴠᴀᴛᴇ",
    "ɴᴏᴛ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ",
    "ʜᴀᴠᴇ ɴᴏ ʀɪɢʜᴛꜱ ᴛᴏ ꜱᴇɴᴅ ᴀ ᴍᴇꜱꜱᴀɢᴇ",
}
...
UNFBAN_ERRORS = {
    ...
    "ɴᴏᴛ ᴇɴᴏᴜɢʜ ʀɪɢʜᴛꜱ ᴛᴏ ʀᴇꜱᴛʀɪᴄᴛ/ᴜɴʀᴇꜱᴛʀɪᴄᴛ ᴄʜᴀᴛ ᴍᴇᴍʙᴇʀ",
    "ᴜꜱᴇʀ_ɴᴏᴛ_ᴘᴀʀᴛɪᴄɪᴘᴀɴᴛ",
    "ᴍᴇᴛʜᴏᴅ ɪꜱ ᴀᴠᴀɪʟᴀʙʟᴇ ғᴏʀ ꜱᴜᴘᴇʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴄʜᴀɴɴᴇʟ chats only",
    "ɴᴏᴛ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ",
    "ᴄʜᴀɴɴᴇʟ_ᴘʀɪᴠᴜɪʀᴇᴅ",
    "ᴄʜᴀᴛ_ᴀᴅᴍɪɴ_ʀᴇϙᴜɪʀᴇᴅ",
    "ʜᴀᴠᴇ ɴᴏ ʀɪɢʜᴛꜱ ᴛᴏ ꜱᴇɴᴅ ᴀ ᴍᴇꜱꜱᴀɢᴇ",
...
def new_fed(update: Update, context: CallbackContext):
    ...
    if chat.type != "private":
        update.effective_message.reply_text(
            "ғᴇᴅᴇʀᴀᴛɪᴏɴꜱ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴘʀɪᴠᴀᴛᴇʟʏ ᴍᴇꜱꜱᴀɢɪɴɢ ᴍᴇ.",
        )
        return
    if len(message.text) == 1:
        send_message(
            update.effective_message,
            "ᴘʟᴇᴀꜱᴇ ᴡʀɪᴛᴇ ᴛʜᴇ ɴᴀᴍᴇ ᴏғ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ!",
        )
        return
    ...
    if not fednam == "":
        ...
        if not x:
            update.effective_message.reply_text(
                f"ᴄᴀɴ'ᴛ ғᴇᴅᴇʀᴀᴛᴇ! ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ @{SUPPORT_CHAT} ɪғ ᴛʜᴇ problem ᴘᴇʀꜱɪꜱᴛ.",
            )
            return

        update.effective_message.reply_text(
            "*ʏᴏᴜ ʜᴀᴠᴇ ꜱᴜᴄᴄᴇᴇᴅᴇᴅ in ᴄʀᴇᴀᴛɪɴɢ ᴀ ɴᴇᴡ ғᴇᴅᴇʀᴀᴛɪᴏɴ!*"
            "\nɴᴀᴍᴇ: `{}`"
            "\nɪᴅ: `{}`"
            "\n\nᴜꜱᴇ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ʙᴇʟᴏᴡ ᴛᴏ ᴊᴏɪɴ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ:"
            "\n`/ᴊᴏɪɴғᴇᴅ {}`".format(fed_name, fed_id, fed_id),
        ...
        try:
            ...
            LOGGER.warning("ᴄᴀɴɴᴏᴛ ꜱᴇɴᴅ ᴀ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ EVENT_LOGS")
    else:
        update.effective_message.reply_text(
            "ᴘʟᴇᴀꜱᴇ ᴡʀɪᴛᴇ ᴅᴏᴡɴ ᴛʜᴇ ɴᴀᴍᴇ of ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ",
        )
...
def del_fed(update: Update, context: CallbackContext):
    ...
    if chat.type != "private":
        update.effective_message.reply_text(
            "ғᴇᴅᴇʀᴀᴛɪᴏɴꜱ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ʙʏ ᴘʀɪᴠᴀᴛᴇʟʏ ᴍᴇꜱꜱᴀɢɪɴɢ ᴍᴇ.",
        )
        return
    if args:
        is_fed_id = args[0]
        ...
        if int(getinfo["owner"]) == int(user.id) or int(user.id) == OWNER_ID:
            ...
            update.effective_message.reply_text("ᴏɴʟʏ ғᴇᴅᴇʀᴀᴛɪᴏɴ ᴏᴡɴᴇʀꜱ ᴄᴀɴ ᴅᴏ ᴛʜɪꜱ!")
            return
    else:
        update.effective_message.reply_text("ᴡʜᴀᴛ ꜱʜᴏᴜʟᴅ ɪ ᴅᴇʟᴇᴛᴇ?")
        return
    ...
    update.effective_message.reply_text(
        "ʏᴏᴜ ꜱᴜʀᴇ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ғᴇᴅᴇʀᴀᴛɪᴏɴ? ᴛʜɪꜱ ᴄᴀɴɴᴏᴛ ʙᴇ ʀᴇᴠᴇʀᴛᴇᴅ, ʏᴏᴜ ᴡɪʟʟ ʟᴏꜱᴇ ʏᴏᴜʀ ᴇɴᴛɪʀᴇ ʙᴀɴ ʟɪꜱᴛ, ᴀɴᴅ '{}' ᴡɪʟʟ ʙᴇ ᴘᴇʀᴍᴀɴᴇɴᴛʟʏ ʟᴏꜱᴛ.".format(
            getinfo["fname"],
        ),
...
def rename_fed(update, context):
    ...
    if len(args) < 3:
        return msg.reply_text("ᴜꜱᴀɢᴇ: /renamefed <fed_id> <newname>")

    fed_id, newname = args[1], args[2]
    verify_fed = sql.get_fed_info(fed_id)

    if not verify_fed:
        return msg.reply_text("ᴛʜɪꜱ ғᴇᴅ ɴᴏᴛ ᴇxɪꜱᴛ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ!")

    if is_user_fed_owner(fed_id, user.id):
        sql.rename_fed(fed_id, user.id, newname)
        msg.reply_text(f"ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ ʀᴇɴᴀᴍᴇᴅ ʏᴏᴜʀ ғᴇᴅ ɴᴀᴍᴇ ᴛᴏ {newname}!")
    else:
        msg.reply_text("ᴏɴʟʏ ғᴇᴅᴇʀᴀᴛɪᴏɴ ᴏᴡɴᴇʀ ᴄᴀɴ ᴅᴏ ᴛʜɪꜱ!")
...
def fed_chat(update: Update, context: CallbackContext):
    ...
    if not is_user_admin(update.effective_chat, user_id):
        update.effective_message.reply_text(
            "ʏᴏᴜ ᴍᴜꜱᴛ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ᴛᴏ ᴇxᴇᴄᴜᴛᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ",
        )
        return

    if not fed_id:
        update.effective_message.reply_text("ᴛʜɪꜱ ɢʀᴏᴜᴘ ɪꜱ ɴᴏᴛ ɪɴ ᴀɴʏ ғᴇᴅᴇʀᴀᴛɪᴏɴ!")
        return
    ...
    text = "ᴛʜɪꜱ ɢʀᴏᴜᴘ 𝚒𝚜 ᴘᴀʀᴛ ᴏғ ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ғᴇᴅᴇʀᴀᴛɪᴏɴ:"
...
def join_fed(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        send_message(
            update.effective_message,
            "ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ꜱᴘᴇᴄɪғɪᴄ ᴛᴏ ᴛʜᴇ ɢʀᴏᴜᴘ, ɴᴏᴛ ᴛᴏ ᴏᴜʀ ᴘᴍ!",
        )
        return
        ...
        for admin in administrators:
            ...
            if status == "ᴄʀᴇᴀᴛᴏʀ":
                if str(admin.user.id) == str(user.id):
                    ...
                    return
    if fed_id:
        message.reply_text("ʏᴏᴜ cannot join two federations from one chat")
        return

    if len(args) >= 1:
        getfed = sql.search_fed_by_id(args[0])
        if getfed is False:
            message.reply_text("ᴘʟᴇᴀꜱᴇ ᴇɴᴛᴇʀ ᴀ ᴠᴀʟɪᴅ ғᴇᴅᴇʀᴀᴛɪᴏɴ ɪᴅ")
            return

        x = sql.chat_join_fed(args[0], chat.title, chat.id)
        if not x:
            message.reply_text(
                f"ғᴀɪʟᴇᴅ ᴛᴏ ᴊᴏɪɴ ғᴇᴅᴇʀᴀᴛɪᴏɴ! ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ @{SUPPORT_CHAT} ꜱʜᴏᴜʟᴅ ᴛʜɪꜱ ᴘʀᴏʙʟᴇᴍ ᴘᴇʀꜱɪꜱᴛ!",
            )
            return
        ...
        if get_fedlog:
            if ast.literal_eval(get_fedlog):
                bot.send_message(
                    get_fedlog,
                    "ᴄʜᴀᴛ *{}* ʜᴀꜱ ᴊᴏɪɴᴇᴅ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ *{}*".format(
                        chat.title,
                        getfed["fname"],
                    ),
                    parse_mode="markdown",
        ...
        message.reply_text(
            "ᴛʜɪꜱ ɢʀᴏᴜᴘ ʜᴀꜱ ᴊᴏɪɴᴇᴅ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ: {}!".format(getfed["fname"]),
        )
...
def leave_fed(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        send_message(
            update.effective_message,
            "ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ꜱᴘᴇᴄɪғɪᴄ ᴛᴏ ᴛʜᴇ ɢʀᴏᴜᴘ, ɴᴏᴛ ᴛᴏ ᴏᴜʀ 𝙿𝙼!",
        )
        return
    ...
    if getuser in "creator" or user.id in DRAGONS:
        if sql.chat_leave_fed(chat.id) is True:
            ...
            if get_fedlog:
                if ast.literal_eval(get_fedlog):
                    bot.send_message(
                        get_fedlog,
                        "ᴄʜᴀᴛ *{}* ʜᴀꜱ ʟᴇғᴛ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ *{}*".format(
                            chat.title,
                            fed_info["fname"],
                        ),
                        parse_mode="markdown",
            ...
            send_message(
                update.effective_message,
                "ᴛʜɪꜱ ɢʀᴏᴜᴘ ʜᴀꜱ ʟᴇғᴛ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ {}!".format(fed_info["fname"]),
            )
        else:
            update.effective_message.reply_text(
        ...
        update.effective_message.reply_text("ᴏɴʟʏ ɢʀᴏᴜᴘ 𝚌𝚛𝚎𝚊𝚝𝚘𝚛𝚜 ᴄᴀɴ ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ!")
...
def user_join_fed(update: Update, context: CallbackContext):
    ...
    if is_user_fed_owner(fed_id, user.id) or user.id in DRAGONS:
        ...
        if user_id:
            ...
            msg.reply_text("I ᴄᴀɴɴᴏᴛ ᴇxᴛʀᴀᴄᴛ ᴜsᴇʀ ғʀᴏᴍ ᴛʜɪs ᴍᴇssᴀɢᴇ")
            return
        else:
        ...
        if user_id == get_owner:
            update.effective_message.reply_text(
                "ʏᴏᴜ ᴅᴏ ᴋɴᴏᴡ ᴛʜᴀᴛ ᴛʜᴇ ᴜsᴇʀ ɪs ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ ᴏᴡɴᴇʀ, ʀɪɢʜᴛ? ʀɪɢʜᴛ?",
            )
            return
        if getuser:
            update.effective_message.reply_text(
...
def __stats__():
    ...
    return "× {} ʙᴀɴɴᴇᴅ ᴜꜱᴇʀꜱ ᴀᴄʀᴏꜱꜱ {} ғᴇᴅᴇʀᴀᴛɪᴏɴꜱ".format(
        len(all_fbanned),
        len(all_feds),
    )
