...
from GalaxiaRobot.modules.helper_funcs.msg_types import Types
from GalaxiaRobot.modules.sql import BASE, SESSION
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "{first} ᴊᴜsᴛ ᴡᴇɴᴛ ᴏғғʟɪɴᴇ.",
    "{first} ʜᴀs ʟᴇғᴛ ᴛʜᴇ ʟᴏʙʙʏ.",
    "{first} ʜᴀs ʟᴇғᴛ ᴛʜᴇ ᴄʟᴀɴ.",
    "{first} ʜᴀs ʟᴇғᴛ ᴛʜᴇ ɢᴀᴍᴇ.",
    "{first} ʜᴀs ғʟᴇᴅ ᴛʜᴇ ᴀʀᴇᴀ.",
    "{first} ɪs ᴏᴜᴛ ᴏғ ᴛʜᴇ ʀᴜɴɴɪɴɢ.",
    "ɴɪᴄᴇ ᴋɴᴏᴡɪɴɢ ʏᴀ, {first}!",
    "ɪᴛ ᴡᴀs ᴀ ғᴜɴ ᴛɪᴍᴇ {first}.",
    "ᴡᴇ ʜᴏᴘᴇ ᴛᴏ sᴇᴇ ʏᴏᴜ ᴀɢᴀɪɴ sᴏᴏɴ, {first}.",
    "ɪ ᴅᴏɴᴜᴛ ᴡᴀɴᴛ ᴛᴏ sᴀʏ ɢᴏᴏᴅʙʏᴇ, {first}.",
    "ɢᴏᴏᴅʙʏᴇ {first}! ɢᴜᴇss ᴡʜᴏ's ɢᴏɴɴᴀ ᴍɪss ʏᴏᴜ :')",
    "ɢᴏᴏᴅʙʏᴇ {first}! ɪᴛ's ɢᴏɴɴᴀ ʙᴇ ʟᴏɴᴇʟʏ ᴡɪᴛʜᴏᴜᴛ ʏᴀ.",
    "ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ʟᴇᴀᴠᴇ ᴍᴇ ᴀʟᴏɴᴇ ɪɴ ᴛʜɪs ᴘʟᴀᴄᴇ, {first}!",
    "ɢᴏᴏᴅ ʟᴜᴄᴋ ғɪɴᴅɪɴɢ ʙᴇᴛᴛᴇʀ sʜɪᴛ-ᴘᴏsᴛᴇʀs ᴛʜᴀɴ ᴜs, {first}!",
    "ʏᴏᴜ ᴋɴᴏᴡ ᴡᴇ'ʀᴇ ɢᴏɴɴᴀ ᴍɪss ʏᴏᴜ {first}. ʀɪɢʜᴛ? ʀɪɢʜᴛ? ʀɪɢʜᴛ?",
    "ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs, {first}! ʏᴏᴜ'ʀᴇ ᴏғғɪᴄɪᴀʟʟʏ ғʀᴇᴇ ᴏғ ᴛʜɪs ᴍᴇss.",
    "{first}. ʏᴏᴜ ᴡᴇʀᴇ ᴀɴ ᴏᴘᴘᴏɴᴇɴᴛ ᴡᴏʀᴛʜ ғɪɢʜᴛɪɴɢ.",
    "ʏᴏᴜ'ʀᴇ ʟᴇᴀᴠɪɴɢ, {first}? ʏᴀʀᴇ ʏᴀʀᴇ ᴅᴀᴢᴇ.",
    "ʙʀɪɴɢ ʜɪᴍ ᴛʜᴇ ᴘʜᴏᴛᴏ",
    "ɢᴏ ᴏᴜᴛsɪᴅᴇ!",
    "ᴀsᴋ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ",
    "ᴛʜɪɴᴋ ғᴏʀ ʏᴏᴜʀsᴇʟғ",
    "ϙᴜᴇsᴛɪᴏɴ ᴀᴜᴛʜᴏʀɪᴛʏ",
    "ʏᴏᴜ ᴀʀᴇ ᴡᴏʀsʜɪᴘɪɴɢ ᴀ sᴜɴ ɢᴏᴅ",
    "ᴅᴏɴ'ᴛ ʟᴇᴀᴠᴇ ᴛʜᴇ ʜᴏᴜsᴇ ᴛᴏᴅᴀʏ",
    "ɢɪᴠᴇ ᴜᴘ!",
    "ᴍᴀʀʀʏ ᴀɴᴅ ʀᴇᴘʀᴏᴅᴜᴄᴇ",
    "sᴛᴀʏ ᴀsʟᴇᴇᴘ",
    "ᴡᴀᴋᴇ ᴜᴘ",
    "ʟᴏᴏᴋ ᴛᴏ ʟᴀ ʟᴜɴᴀ",
    "sᴛᴇᴠᴇɴ ʟɪᴠᴇs",
    "ᴍᴇᴇᴛ sᴛʀᴀɴɢᴇʀs ᴡɪᴛʜᴏᴜᴛ ᴘʀᴇᴊᴜᴅɪᴄᴇ",
    "ᴀ ʜᴀɴɢᴇᴅ ᴍᴀɴ ᴡɪʟʟ ʙʀɪɴɢ ʏᴏᴜ ɴᴏ ʟᴜᴄᴋ ᴛᴏᴅᴀʏ",
    "ᴡʜᴀᴛ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴏ ᴛᴏᴅᴀʏ?",
    "ʏᴏᴜ ᴀʀᴇ ᴅᴀʀᴋ ɪɴsɪᴅᴇ",
    "ʜᴀᴠᴇ ʏᴏᴜ sᴇᴇɴ ᴛʜᴇ ᴇxɪᴛ?",
    "ɢᴇᴛ ᴀ ʙᴀʙʏ ᴘᴇᴛ ɪᴛ ᴡɪʟʟ ᴄʜᴇᴇʀ ʏᴏᴜ ᴜᴘ.",
    "ʏᴏᴜʀ ᴘʀɪɴᴄᴇss ɪs ɪɴ ᴀɴᴏᴛʜᴇʀ ᴄᴀsᴛʟᴇ.",
    "ʏᴏᴜ ᴀʀᴇ ᴘʟᴀʏɪɴɢ ɪᴛ ᴡʀᴏɴɢ ɢɪᴠᴇ ᴍᴇ ᴛʜᴇ ᴄᴏɴᴛʀᴏʟʟᴇʀ",
    "ᴛʀᴜsᴛ ɢᴏᴏᴅ ᴘᴇᴏᴘʟᴇ",
    "ʟɪᴠᴇ ᴛᴏ ᴅɪᴇ.",
    "ᴡʜᴇɴ ʟɪғᴇ ɢɪᴠᴇs ʏᴏᴜ ʟᴇᴍᴏɴs ʀᴇʀᴏʟʟ!",
    "ᴡᴇʟʟ, ᴛʜᴀᴛ ᴡᴀs ᴡᴏʀᴛʜʟᴇss",
    "ɪ ғᴇʟʟ ᴀsʟᴇᴇᴘ!",
    "ᴍᴀʏ ʏᴏᴜʀ ᴛʀᴏᴜʙʟᴇs ʙᴇ ᴍᴀɴʏ",
    "ʏᴏᴜʀ ᴏʟᴅ ʟɪғᴇ ʟɪᴇs ɪɴ ʀᴜɪɴ",
    "ᴀʟᴡᴀʏs ʟᴏᴏᴋ ᴏɴ ᴛʜᴇ ʙʀɪɢʜᴛ sɪᴅᴇ",
    "ɪᴛ ɪs ᴅᴀɴɢᴇʀᴏᴜs ᴛᴏ ɢᴏ ᴀʟᴏɴᴇ",
    "ʏᴏᴜ ᴡɪʟʟ ɴᴇᴠᴇʀ ʙᴇ ғᴏʀɢɪᴠᴇɴ",
    "ʏᴏᴜ ʜᴀᴠᴇ ɴᴏʙᴏᴅʏ ᴛᴏ ʙʟᴀᴍᴇ ʙᴜᴛ ʏᴏᴜʀsᴇʟғ",
    "ᴏɴʟʏ ᴀ sɪɴɴᴇʀ",
    "ᴜsᴇ ʙᴏᴍʙs ᴡɪsᴇʟʏ",
    "ɴᴏʙᴏᴅʏ ᴋɴᴏᴡs ᴛʜᴇ ᴛʀᴏᴜʙʟᴇs ʏᴏᴜ ʜᴀᴠᴇ sᴇᴇɴ",
    "ʏᴏᴜ ʟᴏᴏᴋ ғᴀᴛ ʏᴏᴜ sʜᴏᴜʟᴅ ᴇxᴇʀᴄɪsᴇ ᴍᴏʀᴇ",
    "ғᴏʟʟᴏᴡ ᴛʜᴇ ᴢᴇʙʀᴀ",
    "ᴡʜʏ sᴏ ʙʟᴜᴇ?",
    "ᴛʜᴇ ᴅᴇᴠɪʟ ɪɴ ᴅɪsɢᴜɪsᴇ",
    "ɢᴏ ᴏᴜᴛsɪᴅᴇ",
    "ᴀʟᴡᴀʏs ʏᴏᴜʀ ʜᴇᴀᴅ ɪɴ ᴛʜᴇ ᴄʟᴏᴜᴅs",
]
