...
from GalaxiaRobot import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from GalaxiaRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from GalaxiaRobot.modules.sql.users_sql import get_all_users
    ...
    for user_obj in users:
        try:
            ...
            if excp.message == "Chat not found":
                ...
                LOGGER.exception("ᴇʀʀᴏʀ ᴇxᴛʀᴀᴄᴛɪɴɢ ᴜꜱᴇʀ ID")
...
def broadcast(update: Update, context: CallbackContext):
    ...
    if len(to_send) >= 2:
        ...
        update.effective_message.reply_text(
            f"ʙʀᴏᴀᴅᴄᴀꜱᴛ ᴄᴏᴍᴘʟᴇᴛᴇ.\nɢʀᴏᴜᴘꜱ ғᴀɪʟᴇᴅ: {failed}.\nᴜꜱᴇʀꜱ ғᴀɪʟᴇᴅ: {failed_user}.",
        )
...
def chats(update: Update, context: CallbackContext):
    ...
    with BytesIO(str.encode(chatfile)) as output:
        ...
        update.effective_message.reply_document(
            ...
            caption="ʜᴇʀᴇ ʙᴇ ᴛʜᴇ ʟɪꜱᴛ ᴏғ ɢʀᴏᴜᴘꜱ ɪɴ ᴀꜱᴜx ᴅᴀᴛᴀʙᴀꜱᴇ.",
        )
