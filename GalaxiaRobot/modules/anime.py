...
def shorten(description, info="anilist.co"):
    ...
    if len(description) > 700:
        ...
        msg += f"\n*ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ*: _{description}_[Read More]({info})"
    else:
        msg += f"\n*ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ*:_{description}_"
    return msg


# time formatter from uniborg
def t(milliseconds: int) -> str:
    """ɪɴᴘᴜᴛꜱ ᴛɪᴍᴇ ɪɴ ᴍɪʟʟɪsᴇᴄᴏɴᴅs, ᴛᴏ ɢᴇᴛ ʙᴇᴀᴜᴛɪғɪᴇᴅ ᴛɪᴍᴇ,
    as string"""
...
def airing(update: Update, context: CallbackContext):
    ...
    if len(search_str) == 1:
        update.effective_message.reply_text(
            "ғᴏʀᴍᴀᴛ : /airing < anime name >", parse_mode=ParseMode.MARKDOWN
        )
        return
...
def user(update: Update, context: CallbackContext):
    ...
    try:
        ...
        update.effective_message.reply_text("ᴜꜱᴇʀɴᴀᴍᴇ ɴᴏᴛ ғᴏᴜɴᴅ.")
        return
...
def button(update: Update, context: CallbackContext):
    ...
    if query_type == "anime_close":
        if query.from_user.id in user_and_admin_list:
            ...
            query.answer("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ.")
...
def site_search(update: Update, context: CallbackContext, site: str):
    ...
    try:
        ...
        message.reply_text("ɢɪᴠᴇ ꜱᴏᴍᴇᴛʜɪɴɢ ᴛᴏ ꜱᴇᴀʀᴄʜ")
        return
    ...
    if site == "kaizoku":
        ...
        if search_result:
            result = f"<b>ꜱᴇᴀʀᴄʜ ʀᴇꜱᴜʟᴛꜱ ғᴏʀ</b> <code>{html.escape(search_query)}</code> <b>on</b> <code>AnimeKaizoku</code>: \n"
            ...
            more_results = False
            result = f"<b>ɴᴏ ʀᴇꜱᴜʟᴛ ғᴏᴜɴᴅ for</b> <code>{html.escape(search_query)}</code> <b>on</b> <code>AnimeKaizoku</code>"
        ...
        result = f"<b>ꜱᴇᴀʀᴄʜ ʀᴇꜱᴜʟᴛꜱ ғᴏʀ</b> <code>{html.escape(search_query)}</code> <b>on</b> <code>AnimeKayo</code>: \n"
        for entry in search_result:

            if entry.text.strip() == "ɴᴏᴛʜɪɴɢ ғᴏᴜɴᴅ":
                result = f"<b>ɴᴏ ʀᴇꜱᴜʟᴛ ғᴏᴜɴᴅ for</b> <code>{html.escape(search_query)}</code> <b>on</b> <code>AnimeKayo</code>"
                more_results = False
                break
    ...
    buttons = [[InlineKeyboardButton("ꜱᴇᴇ ᴀʟʟ ʀᴇꜱᴜʟᴛꜱ", url=search_url)]]
