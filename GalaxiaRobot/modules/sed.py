...
from GalaxiaRobot.modules.disable import DisableAbleMessageHandler
from GalaxiaRobot.modules.helper_funcs.regex_helper import infinite_loop_check
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        if not repl:
            update.effective_message.reply_to_message.reply_text(
                "ʏᴏᴜ'ʀᴇ ᴛʀʏɪɴɢ ᴛᴏ ʀᴇᴘʟᴀᴄᴇ... " "ɴᴏᴛʜɪɴɢ ᴡɪᴛʜ ꜱᴏᴍᴇᴛʜɪɴɢ?"
            )
            return
        ...
        try:
            ...
            update.effective_message.reply_text("ᴅᴏ ʏᴏᴜ ᴇᴠᴇɴ ꜱᴇᴅ? ᴀᴘᴘᴀʀᴇɴᴛʟʏ ɴᴏᴛ.")
            return

        # empty string errors -_-
        if len(text) >= telegram.MAX_MESSAGE_LENGTH:
            update.effective_message.reply_text(
                "ᴛʜᴇ ʀᴇꜱᴜʟᴛ ᴏғ ᴛʜᴇ ꜱᴇᴅ ᴄᴏᴍᴍᴀɴᴅ ᴡᴀꜱ ᴛᴏᴏ ʟᴏɴɢ ғᴏʀ \
                                                 telegram!"
            )
        elif text:
