...
import GalaxiaRobot.modules.sql.blsticker_sql as sql
    ...
    if len(words) > 1:
        ...
        for trigger in to_blacklist:
            try:
                ...
                send_message(
                    update.effective_message,
                    "ꜱᴛɪᴄᴋᴇʀ `{}` ᴄᴀɴ ɴᴏᴛ ʙᴇ ғᴏᴜɴᴅ!".format(trigger),
                    parse_mode="markdown",
                )
        ...
        if trigger is None:
            send_message(update.effective_message, "ꜱᴛɪᴄᴋᴇʀ ɪꜱ ɪɴᴠᴀʟɪᴅ!")
            return
        try:
            bot.getStickerSet(trigger)
            sql.add_to_stickers(chat_id, trigger.lower())
        ...
        send_message(
            update.effective_message,
            "ᴛᴇʟʟ ᴍᴇ ᴡʜᴀᴛ ꜱᴛɪᴄᴋᴇʀꜱ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ᴛᴏ ᴛʜᴇ ʙʟᴀᴄᴋʟɪꜱᴛ.",
        )
    ...
    if len(words) > 1:
        ...
        if len(to_unblacklist) == 1:
            if successful:
                send_message(
                    update.effective_message,
                    "ꜱᴛɪᴄᴋᴇʀ <code>{}</code> ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ʙʟᴀᴄᴋʟɪꜱᴛ ɪɴ <b>{}</b>!".format(
                ...
                send_message(
                    update.effective_message,
                    "ᴛʜɪꜱ ꜱᴛɪᴄᴋᴇʀ ɪꜱ ɴᴏᴛ ᴏɴ ᴛʜᴇ ʙʟᴀᴄᴋʟɪꜱᴛ...!",
                )
            ...
            send_message(
                update.effective_message,
                "ɴᴏɴᴇ ᴏғ ᴛʜᴇꜱᴇ ꜱᴛɪᴄᴋᴇʀꜱ ᴇxɪꜱᴛ, ꜱᴏ ᴛʜᴇʏ ᴄᴀɴɴᴏᴛ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ.",
                parse_mode=ParseMode.HTML,
            )
            ...
            send_message(
                update.effective_message,
                "ꜱᴛɪᴄᴋᴇʀ <code>{}</code> ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ʙʟᴀᴄᴋʟɪꜱᴛ. {} ᴅɪᴅ ɴᴏᴛ ᴇxɪꜱᴛ, ꜱᴏ ɪᴛ'ꜱ ɴᴏᴛ ᴅᴇʟᴇᴛᴇᴅ.".format(
                    successful,
        ...
        if success:
            ...
            send_message(
                update.effective_message,
                "{} ɴᴏᴛ ғᴏᴜɴᴅ ᴏɴ ʙʟᴀᴄᴋʟɪꜱᴛᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ...!".format(trigger),
            )
    else:
        send_message(
            update.effective_message,
...
def blacklist_mode(update: Update, context: CallbackContext):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(
                update.effective_message,
                "ʏᴏᴜ ᴄᴀɴ ᴅᴏ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪɴ ɢʀᴏᴜᴘꜱ, ɴᴏᴛ ᴘᴍ",
            )
            return ""
    ...
    if args:
        if args[0].lower() in ["off", "nothing", "no"]:
            ...
            return
        if conn:
            text = "ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀ ᴍᴏᴅᴇ ᴄʜᴀɴɢᴇᴅ, ᴜꜱᴇʀꜱ ᴡɪʟʟ ʙᴇ `{}` ᴀᴛ *{}*!".format(
                settypeblacklist,
                chat_name,
            )
        else:
        ...
        return (
            "<b>{}:</b>\n"
            "<b>ᴀᴅᴍɪɴ:</b> {}\n"
            "ᴄʜᴀɴɢᴇᴅ ꜱᴛɪᴄᴋᴇʀ ʙʟᴀᴄᴋʟɪꜱᴛ ᴍᴏᴅᴇ. ᴜꜱᴇʀꜱ ᴡɪʟʟ ʙᴇ {}.".format(
        ...
        if to_match.set_name.lower() == trigger.lower():
            try:
                ...
                if getmode == 1:
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ʙᴀɴɴᴇᴅ ғᴏʀ {} ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ".format(
                            mention_markdown(user.id, user.first_name),
                            value,
                            trigger,
                        ),
                    ...
                    bot.sendMessage(
                        chat.id,
                        "{} ᴍᴜᴛᴇᴅ ғᴏʀ {} ʙᴇᴄᴀᴜꜱᴇ ᴜꜱɪɴɢ '{}' ᴡʜɪᴄʜ ɪɴ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴛɪᴄᴋᴇʀꜱ".format(
                            mention_markdown(user.id, user.first_name),
                            value,
                            trigger,
                        ),
