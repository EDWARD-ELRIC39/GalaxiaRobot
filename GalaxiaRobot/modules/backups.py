...
# from GalaxiaRobot.modules.sql import warns_sql as warnssql
import GalaxiaRobot.modules.sql.blacklist_sql as blacklistsql

# from GalaxiaRobot.modules.sql import cust_filters_sql as filtersql
# import GalaxiaRobot.modules.sql.welcome_sql as welcsql
import GalaxiaRobot.modules.sql.locks_sql as locksql
import GalaxiaRobot.modules.sql.notes_sql as sql

# from GalaxiaRobot.modules.rules import get_rules
import GalaxiaRobot.modules.sql.rules_sql as rulessql
from GalaxiaRobot import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from GalaxiaRobot.__main__ import DATA_IMPORT
from GalaxiaRobot.modules.connection import connected
from GalaxiaRobot.modules.helper_funcs.alternate import typing_action
from GalaxiaRobot.modules.helper_funcs.chat_status import user_admin
from GalaxiaRobot.modules.sql import disable_sql as disabledsql
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text(
                "ᴛʀʏ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴀɴᴅ ᴜᴘʟᴏᴀᴅɪɴɢ ᴛʜᴇ ғɪʟᴇ ʏᴏᴜʀꜱᴇʟғ ᴀɢᴀɪɴ, ᴛʜɪꜱ ᴏɴᴇ ꜱᴇᴇᴍ ʙʀᴏᴋᴇɴ ᴛᴏ ᴍᴇ!",
            )
            return
        ...
        if len(data) > 1 and str(chat.id) not in data:
            msg.reply_text(
                "ᴛʜᴇʀᴇ ᴀʀᴇ ᴍᴏʀᴇ ᴛʜᴀɴ ᴏɴᴇ ɢʀᴏᴜᴘ ɪɴ ᴛʜɪꜱ ғɪʟᴇ ᴀɴᴅ ᴛʜᴇ chat.id ɪꜱ ɴᴏᴛ ꜱᴀᴍᴇ! ʜᴏᴡ ᴀᴍ ɪ ꜱᴜᴘᴘᴏꜱᴇᴅ ᴛᴏ ɪᴍᴘᴏʀᴛ ɪᴛ?",
            )
            return
        ...
        try:
            if data.get(str(chat.id)) is None:
                if conn:
                    text = "ʙᴀᴄᴋᴜᴘ ᴄᴏᴍᴇꜱ ғʀᴏᴍ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ, ɪ ᴄᴀɴ'ᴛ ʀᴇᴛᴜʀɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴛᴏ ᴄʜᴀᴛ *{}*".format(
                        chat_name,
                    )
                else:
                    text = "ʙᴀᴄᴋᴜᴘ ᴄᴏᴍᴇꜱ ғʀᴏᴍ ᴀɴᴏᴛʜᴇʀ 𝚌𝚑𝚊𝚝, ɪ ᴄᴀɴ'ᴛ ʀᴇᴛᴜʀɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴛᴏ ᴛʜɪꜱ ᴄʜᴀᴛ"
        ...
        try:
            if str(context.bot.id) != str(data[str(chat.id)]["bot"]):
                return msg.reply_text(
                    "ʙᴀᴄᴋᴜᴘ ғʀᴏᴍ ᴀɴᴏᴛʜᴇʀ ʙᴏᴛ ᴛʜᴀᴛ ɪꜱ ɴᴏᴛ ꜱᴜɢɢᴇꜱᴛᴇᴅ ᴍɪɢʜᴛ ᴄᴀᴜꜱᴇ ᴛʜᴇ ᴘʀᴏʙʟᴇᴍ, ᴅᴏᴄᴜᴍᴇɴᴛꜱ, ᴘʜᴏᴛᴏꜱ, ᴠɪᴅᴇᴏꜱ, ᴀᴜᴅɪᴏꜱ, ʀᴇᴄᴏʀᴅꜱ ᴍɪɢʜᴛ ɴᴏᴛ ᴡᴏʀᴋ ᴀꜱ ɪᴛ ꜱʜᴏᴜʟᴅ ʙᴇ.",
                )
        except Exception:
            pass
        # Select data source
        ...
        try:
            ...
            msg.reply_text(
                f"ᴀɴ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ ᴡʜɪʟᴇ ʀᴇᴄᴏᴠᴇʀɪɴɢ ʏᴏᴜʀ ᴅᴀᴛᴀ. ᴛʜᴇ ᴘʀᴏᴄᴇꜱꜱ ғᴀɪʟᴇᴅ. ɪғ ʏᴏᴜ ᴇxᴘᴇʀɪᴇɴᴄᴇ ᴀ ᴘʀᴏʙʟᴇᴍ ᴡɪᴛʜ ᴛʜɪꜱ, ᴘʟᴇᴀꜱᴇ ᴛᴀᴋᴇ ɪᴛ ᴛᴏ @{SUPPORT_CHAT}",
            )
        ...
        if conn:
            ...
            text = "ʙᴀᴄᴋᴜᴘ ғᴜʟʟʏ ʀᴇꜱᴛᴏʀᴇᴅ ᴏɴ *{}*.".format(chat_name)
        else:
            text = "ʙᴀᴄᴋᴜᴘ ғᴜʟʟʏ ʀᴇꜱᴛᴏʀᴇᴅ"
...
def export_data(update, context):
    ...
    with open("Galaxia{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Galaxia{}.backup".format(chat_id), "rb"),
        caption="*ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ ᴇxᴘᴏʀᴛᴇᴅ ʙᴀᴄᴋᴜᴘ:*\nᴄʜᴀᴛ: `{}`\nᴄʜᴀᴛ ɪᴅ: `{}`\nOn: `{}`\n\n ɴᴏᴛᴇ: ᴛʜɪꜱ `AbishnoiRobot-Backup` ᴡᴀꜱ ꜱᴘᴇᴄɪᴀʟʟʏ ᴍᴀᴅᴇ ғᴏʀ ɴᴏᴛᴇꜱ.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Galaxia{}.backup".format(chat_id))  # Cleaning file
