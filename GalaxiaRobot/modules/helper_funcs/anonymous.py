...
from GalaxiaRobot import DEV_USERS, OWNER_ID, dispatcher

from .decorators import Galaxiacallback
        ...
        def awrapper(update: Update, context: CallbackContext, *args, **kwargs):
            ...
            if is_anon:
                ...
                anon_callback_messages[(message.chat.id, message.message_id)] = (
                    message.reply_text(
                        "ꜱᴇᴇᴍꜱ ʟɪᴋᴇ ʏᴏᴜ'ʀ ᴀɴᴏɴʏᴍᴏᴜꜱ, ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴘʀᴏᴠᴇ ʏᴏᴜʀ ɪᴅᴇɴᴛɪᴛʏ ʙᴀʙʏ",
                ...
                if (
                    ...
                    return message.reply_text(
                        f"ʏᴏᴜ ʟᴀᴄᴋ ᴛʜᴇ ᴘᴇʀᴍɪꜱꜱɪᴏɴ: `{permission.name}`",
...
@Galaxiacallback(pattern="anoncb")
def anon_callback_handler1(upd: Update, _: CallbackContext):
    ...
    if mem.status not in [ChatStatus.ADMIN.value, ChatStatus.CREATOR.value]:
        ...
        dispatcher.bot.send_message(
            chat_id, "ʏᴏᴜ ʟᴀᴄᴋ ᴛʜᴇ ᴘᴇʀᴍɪꜱꜱɪᴏɴꜱ ʀᴇϙᴜɪʀᴇᴅ ғᴏʀ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ"
        )
    elif (
        ...
        callback.answer("ᴛʜɪs ɪsɴ'ᴛ ғᴏʀ ʏᴀ")
