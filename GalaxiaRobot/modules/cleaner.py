...
from GalaxiaRobot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from GalaxiaRobot.modules.sql import cleaner_sql as sql
...
def set_blue_text_must_click(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if val in ("off", "no"):
            ...
            reply = "ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ ʜᴀꜱ ʙᴇᴇɴ ᴅɪꜱᴀʙʟᴇᴅ ғᴏʀ <b>{}</b>".format(
            ...
            reply = "ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ ʜᴀꜱ ʙᴇᴇɴ ᴇɴᴀʙʟᴇᴅ ғᴏʀ <b>{}</b>".format(
                html.escape(chat.title),
            )
            message.reply_text(reply, parse_mode=ParseMode.HTML)

        else:
            reply = "ɪɴᴠᴀʟɪᴅ ᴀʀɢᴜᴍᴇɴᴛ.ᴀᴄᴄᴇᴘᴛᴇᴅ ᴠᴀʟᴜᴇꜱ ᴀʀᴇ 'yes', 'on', 'no', 'off'"
...
def add_bluetext_ignore(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if added:
            reply = "<b>{}</b> ʜᴀꜱ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴᴇʀ ɪɢɴᴏʀᴇ ʟɪꜱᴛ.".format(
                args[0],
            )
        else:
...
def remove_bluetext_ignore(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if removed:
            reply = (
                "<b>{}</b> ʜᴀꜱ ʙᴇᴇɴ ʀᴇᴍᴏᴠᴇᴅ ғʀᴏᴍ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴᴇʀ ɪɢɴᴏʀᴇ ʟɪꜱᴛ.".format(
                    args[0],
                )
            )
        else:
...
def add_bluetext_ignore_global(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if added:
            reply = "<b>{}</b> ʜᴀꜱ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ɢʟᴏʙᴀʟ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴᴇʀ ɪɢɴᴏʀᴇ ʟɪꜱᴛ.".format(
                args[0],
            )
        else:
            reply = "ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴀʟʀᴇᴀᴅʏ ɪɢɴᴏʀᴇᴅ."
...
def remove_bluetext_ignore_global(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if removed:
            reply = "<b>{}</b> ʜᴀꜱ ʙᴇᴇɴ ʀᴇᴍᴏᴠᴇᴅ ғʀᴏᴍ ɢʟᴏʙᴀʟ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴᴇʀ ɪɢɴᴏʀᴇ ʟɪꜱᴛ.".format(
                args[0],
            )
        else:
            reply = "ᴄᴏᴍᴍᴀɴᴅ ɪꜱɴ'ᴛ ɪɢɴᴏʀᴇᴅ ᴄᴜʀʀᴇɴᴛʟʏ."
...
def bluetext_ignore_list(update: Update, context: CallbackContext):
    ...
    if global_ignored_list:
        text = "ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀʀᴇ ᴄᴜʀʀᴇɴᴛʟʏ ɪɢɴᴏʀᴇᴅ ɢʟᴏʙᴀʟʟʏ ғʀᴏᴍ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ :\n"

        for x in global_ignored_list:
            text += f" - <code>{x}</code>\n"

    if local_ignore_list:
        text += "\n ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀʀᴇ ᴄᴜʀʀᴇɴᴛʟʏ ɪɢɴᴏʀᴇᴅ ʟᴏᴄᴀʟʟʏ ғʀᴏᴍ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ :\n"

        for x in local_ignore_list:
            text += f" - <code>{x}</code>\n"

    if text == "":
        text = "ɴᴏ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀʀᴇ ᴄᴜʀʀᴇɴᴛʟʏ ɪɢɴᴏʀᴇᴅ ғʀᴏᴍ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ."
