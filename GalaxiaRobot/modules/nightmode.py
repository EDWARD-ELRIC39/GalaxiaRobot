...
from GalaxiaRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
...
async def close_ws(event):
    ...
    await event.reply(
        f"Aᴅᴅᴇᴅ ᴄʜᴀᴛ {event.chat.title} ᴡɪᴛʜ ɪᴅ  {event.chat_id} ᴛᴏ ᴅᴀᴛᴀʙᴀs \n **Tʜɪs Gʀᴏᴜᴘ Wɪʟʟ Bᴇ Cʟᴏsᴇᴅ Oɴ 12Aᴍ(IST) Aɴᴅ Wɪʟʟ Oᴘᴇɴᴇᴅ Oɴ 06Aᴍ(IST)**"
    )
