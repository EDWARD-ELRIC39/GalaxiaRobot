...
from GalaxiaRobot.utils.pluginhelper import get_text, progress
...
async def ytmusic(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"`ɢᴇᴛᴛɪɴɢ {urlissed} ғʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ ꜱᴇʀᴠᴇʀꜱ. ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ.`"
    )
    if not urlissed:
        await pablo.edit("ɪɴᴠᴀʟɪᴅ ᴄᴏᴍᴍᴀɴᴅ ꜱʏɴᴛᴀx, ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ʜᴇʟᴘ ᴍᴇɴᴜ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ!")
        return
    ...
    capy = f"**ᴠɪᴅᴇᴏ ɴᴀᴍᴇ ➠** [{thum}]({mo}) \n**ʀᴇϙᴜᴇꜱᴛᴇᴅ ғᴏʀ :** `{urlissed}` \n**ᴄʜᴀɴɴᴇʟ :** `{thums}` "
    await client.send_video(
        ...
        progress_args=(
            pablo,
            c_time,
            f"`ᴜᴘʟᴏᴀᴅɪɴɢ {urlissed} ꜱᴏɴɢ ғʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ ᴍᴜꜱɪᴄ!`",
            file_stark,
        ),
    )
    await pablo.delete()
...
async def ytmusic(client, message: Message):
    ...
    if not urlissed:
        await client.send_message(
            message.chat.id,
            "ɪɴᴠᴀʟɪᴅ ᴄᴏᴍᴍᴀɴᴅ ꜱʏɴᴛᴀx, ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ʜᴇʟᴘ ᴍᴇɴᴜ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ!",
        )
        return
    pablo = await client.send_message(
        message.chat.id, f"`ɢᴇᴛᴛɪɴɢ {urlissed} ғʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ ꜱᴇʀᴠᴇʀꜱ. ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ.`"
