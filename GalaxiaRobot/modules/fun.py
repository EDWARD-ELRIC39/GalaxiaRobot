...
import GalaxiaRobot.modules.fun_strings as fun_strings
...
def runs(update: Update, context: CallbackContext):
    ...
    if update.effective_user.id == 1170714920:
        temp = "ʀᴜɴ ᴇᴠᴇʀʏᴏɴᴇ, ᴛʜᴇʏ ᴊᴜsᴛ ᴅʀᴏᴘᴘᴇᴅ ᴀ ʙᴏᴍʙ 💣💣"
...
def sanitize(update: Update, context: CallbackContext):
    ...
    reply_animation(GIF_ID, caption=f"*sᴀɴɪᴛɪᴢᴇs {name}*")
...
def sanitize(update: Update, context: CallbackContext):
    ...
    reply_animation(random.choice(fun_strings.GIFS), caption=f"*sᴀɴɪᴛɪᴢᴇs {name}*")
