...
import GalaxiaRobot.modules.sql.locks_sql as sql
...
def lock(update, context) -> str:
    ...
    if (
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    text = "ʟᴏᴄᴋᴇᴅ {} ғᴏʀ ɴᴏɴ-ᴀᴅᴍɪɴꜱ ɪɴ {}!".format(ltype, chat_name)
                else:
                    ...
                    text = "ʟᴏᴄᴋᴇᴅ {} ғᴏʀ ɴᴏɴ-ᴀᴅᴍɪɴꜱ!".format(ltype)
            ...
            if ltype in LOCK_CHAT_RESTRICTION:
                ...
                if conn:
                    ...
                    chat_id = conn
                    chat_name = chat.title
                    text = "ʟᴏᴄᴋᴇᴅ {} ғᴏʀ ᴀʟʟ ɴᴏɴ-ᴀᴅᴍɪɴꜱ ɪɴ {}!".format(
                        ltype, chat_name
                    )
                else:
                    if update.effective_message.chat.type == "private":
                        send_message(
                            update.effective_message,
                            "ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴍᴇᴀɴᴛ ᴛᴏ ᴜꜱᴇ ɪɴ ɢʀᴏᴜᴘ not ɪɴ ᴘᴍ",
                        )
                        return ""
                    chat = update.effective_chat
                    chat_id = update.effective_chat.id
            ...
            send_message(
                update.effective_message,
                "ᴡʜᴀᴛ ᴀʀᴇ ʏᴏᴜ ᴛʀʏɪɴɢ ᴛᴏ ʟᴏᴄᴋ...? ᴛʀʏ /locktypes ғᴏʀ ᴛʜᴇ ʟɪꜱᴛ ᴏғ ʟᴏᴄᴋᴀʙʟᴇꜱ",
            )
        else:
        ...
        send_message(
            update.effective_message,
            "ɪ ᴀᴍ ɴᴏᴛ ᴀᴅᴍɪɴɪꜱᴛʀᴀᴛᴏʀ ᴏʀ ʜᴀᴠᴇɴ'ᴛ ɢᴏᴛ ᴇɴᴏᴜɢʜ ʀɪɢʜᴛꜱ.",
        )
            ...
            if ltype in UNLOCK_CHAT_RESTRICTION:
                ...
                if conn:
                    ...
                    if update.effective_message.chat.type == "private":
                        send_message(
                            update.effective_message,
                            "ᴛʜɪs command ɪꜱ ᴍᴇᴀɴᴛ ᴛᴏ ᴜꜱᴇ ɪɴ ɢʀᴏᴜᴘ ɴᴏᴛ ɪɴ PM",
                        )
                        return ""
                    chat = update.effective_chat
                    chat_id = update.effective_chat.id
            ...
            if lockable == "bots":
                ...
                for new_mem in new_members:
                    if new_mem.is_bot:
                        ...
                        send_message(
                            update.effective_message,
                            "ᴏɴʟʏ ᴀᴅᴍɪɴꜱ ᴀʀᴇ ᴀʟʟᴏᴡᴇᴅ to ᴀᴅᴅ ʙᴏᴛꜱ ɪɴ ᴛʜɪꜱ ᴄʜᴀᴛ! ɢᴇᴛ ᴏᴜᴛᴛᴀ ʜᴇʀᴇ.",
                        )
                        break
            else:
                try:
                    ...
                    if excp.message != "ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ᴅᴇʟᴇᴛᴇ ɴᴏᴛ ғᴏᴜɴᴅ":
                        LOGGER.exception("ᴇʀʀᴏʀ ɪɴ ʟᴏᴄᴋᴀʙʟᴇꜱ")
...
def list_locks(update, context):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(
                update.effective_message,
                "ᴛʜɪꜱ command ɪꜱ ᴍᴇᴀɴᴛ ᴛᴏ ᴜꜱᴇ ɪɴ ɢʀᴏᴜᴘ ɴᴏᴛ ɪɴ PM",
            )
            return ""
        chat = update.effective_chat
        chat_name = update.effective_message.chat.title
