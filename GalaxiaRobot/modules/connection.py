...
import GalaxiaRobot.modules.sql.connection_sql as sql
from GalaxiaRobot import DEV_USERS, DRAGONS, dispatcher
from GalaxiaRobot.modules.helper_funcs import chat_status
        ...
        if len(args) >= 1:
            ...
            if var == "no":
                ...
                send_message(
                    ...
                    "ᴄᴏɴɴᴇᴄᴛɪᴏɴ ʜᴀꜱ ʙᴇᴇɴ ᴅɪꜱᴀʙʟᴇᴅ ғᴏʀ ᴛʜɪꜱ ᴄʜᴀᴛ",
                )
            elif var == "yes":
                sql.set_allow_connect_to_chat(chat.id, True)
                send_message(
                    update.effective_message,
                    "ᴄᴏɴɴᴇᴄᴛɪᴏɴ ʜᴀꜱ ʙᴇᴇɴ ᴇɴᴀʙʟᴇᴅ ғᴏʀ ᴛʜɪꜱ ᴄʜᴀᴛ",
                )
            else:
                send_message(
                    update.effective_message,
                    "ᴘʟᴇᴀꜱᴇ ᴇɴᴛᴇʀ `yes` ᴏʀ `no`!",
            ...
            if get_settings:
                send_message(
                    update.effective_message,
                    "ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ ᴛᴏ ᴛʜɪꜱ ɢʀᴏᴜᴘ ᴀʀᴇ *ᴀʟʟᴏᴡᴇᴅ* ғᴏʀ ᴍᴇᴍʙᴇʀꜱ!",
                    parse_mode=ParseMode.MARKDOWN,
                )
            else:
                send_message(
                    update.effective_message,
                    "ᴄᴏɴɴᴇᴄᴛɪᴏɴ ᴛᴏ ᴛʜɪꜱ ɢʀᴏᴜᴘ ᴀʀᴇ *ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ* ғᴏʀ ᴍᴇᴍʙᴇʀꜱ!",
                    parse_mode=ParseMode.MARKDOWN,
                )
    else:
        send_message(
            update.effective_message,
            "ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ғᴏʀ ɢʀᴏᴜᴘ ᴏɴʟʏ. ɴᴏᴛ ɪɴ PM!",
        )
        ...
        if args and len(args) >= 1:
            ...
            if (isadmin) or (isallow and ismember) or (user.id in DRAGONS):
                ...
                if connection_status:
                    ...
                    send_message(
                        update.effective_message,
                        "ꜱᴜᴄᴄᴇꜱꜱғᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ *{}*. \n ᴜꜱᴇ `/helpconnect` ᴛᴏ ᴄʜᴇᴄᴋ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ.".format(
                            chat_name,
                        ),
                        parse_mode=ParseMode.MARKDOWN,
                    )
                ...
                send_message(
                    update.effective_message,
                    "ᴄᴏɴɴᴇᴄᴛɪᴏɴ ᴛᴏ ᴛʜɪꜱ ᴄʜᴀᴛ ɪꜱ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ!",
                )
        else:
    ...
    if chat.type == chat.PRIVATE and sql.get_connected_chat(user_id):
        ...
        if (
            ...
            if need_admin is True:
                ...
                send_message(
                    update.effective_message,
                    "ʏᴏᴜ ᴍᴜꜱᴛ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ!",
                )
            else:
                return conn_id
        else:
...
def help_connect_chat(update, context):
    ...
    if update.effective_message.chat.type != "private":
        send_message(update.effective_message, "PM ᴍᴇ ᴡɪᴛʜ ᴛʜᴀᴛ ᴄᴏᴍᴍᴀɴᴅ 𝚝𝚘 ɢᴇᴛ ʜᴇʟᴘ.")
        return
...
def connect_button(update, context):
    ...
    if connect_match:
        ...
        if disconnection_status:
            sql.disconnected_chat = query.message.edit_text("ᴅɪꜱᴄᴏɴɴᴇᴄᴛᴇᴅ ғʀᴏᴍ ᴄʜᴀᴛ!")
        else:
            context.bot.answer_callback_query(
                query.id,
