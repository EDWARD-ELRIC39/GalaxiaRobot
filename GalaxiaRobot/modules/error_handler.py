...
from GalaxiaRobot import DEV_USERS, ERROR_LOG, dispatcher

pretty_errors.mono()


class ErrorsDict(dict):
    """ᴀ ᴄᴜꜱᴛᴏᴍ ᴅɪᴄᴛ ᴛᴏ ꜱᴛᴏʀᴇ ᴇʀʀᴏʀꜱ ᴀɴᴅ ᴛʜᴇɪʀ ᴄᴏᴜɴᴛ"""
    ...
    if context.error not in errors:
        ...
        context.bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("ᴄᴜʀꜱᴇᴅ ᴇʀʀᴏʀꜱ", url=url)]],
            ),
            parse_mode="html",
        )
...
def list_errors(update: Update, context: CallbackContext):
    ...
    if len(msg) > 4096:
        ...
        context.bot.send_document(
            ...
            caption="ᴛᴏᴏ ᴍᴀɴʏ ᴇʀʀᴏʀꜱ ʜᴀᴠᴇ ᴏᴄᴄᴜʀᴇᴅ..",
            parse_mode="html",
        )
        return
