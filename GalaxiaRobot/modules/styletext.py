...
def weebify(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/weebify <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def bubble(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/bubble <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def fbubble(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/fbubble <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def square(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/square <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def fsquare(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/fsquare <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def blue(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/blue <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def asau(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/asau <text>`", parse_mode=ParseMode.MARKDOWN)
        return

    for normiecharacter in string:
        if normiecharacter in normiefont:
            asaucharacter = asaufont[normiefont.index(normiecharacter)]
            string = string.replace(normiecharacter, asaucharacter)
...
ASAU_HANDLER = DisableAbleCommandHandler("asau", asau, run_async=True)
...
dispatcher.add_handler(ASAU_HANDLER)
