...
from GalaxiaRobot.utils.functions import get_urls_from_text as is_url
...
def keyboard(buttons_list, row_width: int = 2):
    ...
    Ex: keyboard([["ᴄʟɪᴄᴋ ʜᴇʀᴇ", "https://google.com"]])
...
def ikb(data: dict, row_width: int = 2):
    ...
    Ex: dict_to_keyboard({"ᴄʟɪᴄᴋ ʜᴇʀᴇ": "ᴛʜɪs ɪs ᴄᴀʟʟʙᴀᴄᴋ ᴅᴀᴛᴀ"})
    """
